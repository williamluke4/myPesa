...
String depositTransaction = '''PK95FQHDN1 Confirmed. On 9/11/21 at 7:07 PM Give Ksh60,000.00 cash to Naivas Supermarket Kilifi New M-PESA balance is Ksh104,061.96. You can now access M-PESA via *334#''';
...
void main() {
  group('parseMpesaTransaction', () {
    ...
    test('depositTransaction', () {
      final transaction = parseMpesaTransaction(depositTransaction) as Transaction;
      expect(transaction.amount, equals('1,000.00'));
      expect(transaction.balance, equals('25,203.19'));
      expect(transaction.txCost, equals('12.00'));
      expect(transaction.type, equals(TransactionType.OUT));
